...
const adminUser = new UserIdentity(uuid(), "Administrator", bcrypt.hashSync("admin123", bcrypt.genSaltSync()), true);

const adminActor = new Actor(uuid(), "Administrator", [adminRole], adminUser);

const defaultPage = new Page(uuid(), "Front page", adminActor, new Date(), 0);
